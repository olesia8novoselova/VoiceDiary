...
similarity = {
    ...
    'fear':      {'anger': 0.9, 'disgust': 0.6, 'fear': 1.0, 'sadness': 0.7, 'joy': 0.0, 'neutral': 0.5, 'surprise': 0.8},
    'joy':       {'anger': 0.0, 'disgust': 0.0, 'fear': 0.0, 'sadness': 0.0, 'joy': 1.0, 'neutral': 0.8, 'surprise': 0.9},
    'neutral':   {'anger': 0.0, 'disgust': 0.6, 'fear': 0.5, 'sadness': 0.9, 'joy': 0.7, 'neutral': 1.0, 'surprise': 0.8},
    'sadness':   {'anger': 0.6, 'disgust': 0.8, 'fear': 0.7, 'sadness': 1.0, 'joy': 0.0, 'neutral': 0.9, 'surprise': 0.5},
    'surprise':  {'anger': 0.6, 'disgust': 0.5, 'fear': 0.8, 'sadness': 0.0, 'joy': 0.9, 'neutral': 0.7, 'surprise': 1.0},
}
